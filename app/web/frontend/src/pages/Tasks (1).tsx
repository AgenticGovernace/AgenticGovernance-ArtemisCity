...
import { createNewTask, executeAllPendingTasks, executePendingTask, fetchAgents, fetchTasks, } from '../api';
  ...
  return (
    <Box>
      <Flex justifyContent="space-between" alignItems="center" mb={4} gap={2} flexWrap="wrap">
        ...
        <Flex gap={2}>
          <Button variant="outline" onClick={handleExecuteAllPending}>
            Run All Pending
          </Button>
          ...
          <ModalBody>
            <VStack spacing={4}>
              ...
              <FormControl isRequired>
                ...
                <Select
                  placeholder={
                    availableCapabilities.length ? 'Select capability' : 'No capabilities available'
                  }
