...
export class TrustController {
  ...
  async setTrustScore(entityId: string, score: number, entityType = 'agent'): Promise<unknown> {
  ...
  async canPerformOperation(entityId: string, operation: string): Promise<unknown> {
