...
| `app/Artemis Agentic Memory Layer/`              | Standalone Obsidian REST shell (`make server`). Not registered in the root workspace, and not a Model Context Protocol implementation despite its name.                                                 |
