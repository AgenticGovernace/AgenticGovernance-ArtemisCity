...
### 4. Enhanced CLI (`interface/Daemon_cli.py`)
...
```bash
# Single command mode
python interface/Daemon_cli.py "ask artemis about the system"

# With ATP headers
python interface/Daemon_cli.py "#Mode: Build #Context: CLI test #ActionType: Execute ask artemis"
...
Create `WARP.md` or `Daemon.md` in project root:
