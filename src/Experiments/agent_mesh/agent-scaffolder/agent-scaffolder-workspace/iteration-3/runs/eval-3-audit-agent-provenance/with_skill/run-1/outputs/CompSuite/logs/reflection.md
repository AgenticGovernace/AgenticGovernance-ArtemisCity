# CompSuite Reflection Log

> Cadence: a summary every **50 actions or every 12 hours**, whichever comes first.
> Each entry follows the format below. This is the destination that makes the Reflection
...
- Next: begin watching voice_logs/ and outputs/.
