...
Cadence summaries from both agents — appended every 10 handoffs/reviews or every 12 hours of
active work, per the Reflection layer in `AGENTS.md`. Inline one-sentence self-checks live in
...
<!-- Append rollups below this line. -->
