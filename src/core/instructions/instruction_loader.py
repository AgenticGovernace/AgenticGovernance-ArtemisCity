...
class InstructionSet:
    ...
    def add_scope(self, scope: InstructionScope) -> None:
        ...
        Args:
            scope (InstructionScope): Scope value used by this operation.
...
class InstructionLoader:
    ...
    GLOBAL_FILES = ["~/.artemis/config.md", "~/.artemis/instructions.md"]

    PROJECT_FILES = ["WARP.md", ".artemis/instructions.md"]
        ...
        for file_pattern in self.GLOBAL_FILES:
            ...
            if content:
                return InstructionScope(
                    level="global", path=file_path, content=content, priority=1
                )
        return None
    ...
    def _load_local_instructions(self, current_dir: str) -> Optional[InstructionScope]:
        ...
        for filename in self.LOCAL_FILES:
            ...
            if content:
                return InstructionScope(
                    level="local", path=file_path, content=content, priority=3
                )
        return None
