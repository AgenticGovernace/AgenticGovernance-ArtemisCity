...
const trustController_1 = require("../controllers/trustController");
const router = (0, express_1.Router)();
const controller = new trustController_1.TrustController();
/**
 ...
 */
router.post('/:entityId/success', async (req, res) => {
    try {
        const { entityId } = req.params;
 ...
 */
router.post('/:entityId/failure', async (req, res) => {
    try {
        const { entityId } = req.params;
 ...
 */
router.get('/:entityId/permissions', async (req, res) => {
    try {
        const { entityId } = req.params;
 ...
 */
router.post('/:entityId/can-perform', async (req, res) => {
    try {
        const { entityId } = req.params;
 ...
 */
router.get('/hebbian/weights', async (req, res) => {
    try {
 ...
 */
router.put('/hebbian/weights', async (req, res) => {
    try {
