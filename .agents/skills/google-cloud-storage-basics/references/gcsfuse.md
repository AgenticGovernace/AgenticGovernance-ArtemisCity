...
- **Rename Atomicity & Hierarchical Namespace (HNS):** Renaming an individual
  ...
  Renaming a _directory_ in a standard flat-namespace bucket, however,
...
- **Optimized Read Path:** GCSFuse automatically utilizes an optimized read
  ...
  - _Note on Caching:_ The optimized read path is incompatible with GCSFuse
  ...
  - _Note on non-GKE hosts:_ Outside GKE, the optimized read path also
...
- **Streaming Persistence:** Object streams are kept open by default for zonal
  ...
  round-trip latency.
  - _Tip:_ To maximize the benefits of streaming persistence, ensure your
